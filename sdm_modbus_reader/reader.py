"""
SDM Modbus Reader - Communication with SDM meters
"""
...
class SDMReader:
    """Reads data from SDM120/SDM630 energy meters via Modbus"""
    ...
    def read_float32(self, device_id: int, register: int) -> Optional[float]:
    ...
    def read_meter(self, device_id: int, meter_type: str) -> Optional[Dict]:
        ...
        for name, register in registers.items():
            value = self.read_float32(device_id, register)
